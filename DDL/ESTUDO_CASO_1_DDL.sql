...
CHANGE COLUMN PROD_QUANT PROD_QUANTIDADE DECIMAL(10,3);

# ALTER ADD INDEX: Adiciona um índice na coluna 'PED_FORNECEDOR' na tabela PEDIDOS
ALTER TABLE PEDIDOS 
ADD INDEX idx_ped_fornecedor (PED_FORNECEDOR);

# DROP TABLE: Exclui a tabela RECEBIMENTOS do banco de dados
